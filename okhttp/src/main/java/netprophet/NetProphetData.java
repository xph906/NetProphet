	 ...
	 * */
        ...
        * */
        ...
        public static final String[][] COLUMNS = new String[][]{
        	{REQUEST_ID,TYPE_PRIMARY_KEY},
        	{URL, TYPE_TEXT},
        	{METHOD, TYPE_TEXT},
        	{USER_ID,TYPE_TEXT},
        	{PREV_REQ_ID,TYPE_INTEGER},
        	{NEXT_REQ_ID,TYPE_INTEGER},
        	{START_TIME,TYPE_INTEGER},
        	{END_TIME,TYPE_INTEGER},
        	{OVERALL_DELAY,TYPE_INTEGER},
        	{DNS_DELAY,TYPE_INTEGER},
        	{CONN_DELAY,TYPE_INTEGER},
        	{HANDSHAKE_DELAY,TYPE_INTEGER},
        	{TLS_DELAY,TYPE_INTEGER},
        	{REQ_WRITE_DELAY,TYPE_INTEGER},
        	{SERVER_DELAY,TYPE_INTEGER},
        	{TTFB_DELAY,TYPE_INTEGER},
        	{RESP_TRANS_DELAY,TYPE_INTEGER},
        	{USE_CONN_CACHE,TYPE_BOOLEAN},
        	{USE_DNS_CACHE,TYPE_BOOLEAN},
        	{USE_RESP_CACHE,TYPE_BOOLEAN},
        	{RESP_SIZE,TYPE_INTEGER},
        	{HTTP_CODE,TYPE_INT},
        	{REQ_SIZE,TYPE_INT},
        	{IS_FAILED_REQUEST,TYPE_BOOLEAN},
        	{ERROR_MSG,TYPE_TEXT},
        	{DETAILED_ERROR_MSG,TYPE_TEXT},
        	{TRANS_ID,TYPE_INTEGER},
        	{TRANS_TYPE,TYPE_INT},
        	{RESP_TYPE, TYPE_TEXT}};
